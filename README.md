...
## Özellikleri
- NuGet aracılığıyla yükleyebilme. ([BinanceTR](https://www.nuget.org/packages/BinanceTR/1.2.5))
...
## Kurulum
Bu kütüphane NuGet'te mevcuttur, indirmek için çekinmeyin. ([https://www.nuget.org/packages/BinanceTR/1.2.5](https://www.nuget.org/packages/BinanceTR/1.2.5 "https://www.nuget.org/packages/BinanceTR/1.2.5"))

**NuGet PM**
```
Install-Package BinanceTR -Version 1.2.5
```

**dotnet cli**
```
dotnet add package BinanceTR --version 1.2.5
```
## Yol Haritası
