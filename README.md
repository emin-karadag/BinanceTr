...
## Özellikleri
- NuGet aracılığıyla yükleyebilme. ([BinanceTR](https://www.nuget.org/packages/BinanceTR/1.2.3))
...
## Kurulum
Bu kütüphane NuGet'te mevcuttur, indirmek için çekinmeyin. ([https://www.nuget.org/packages/BinanceTR/1.2.3](https://www.nuget.org/packages/BinanceTR/1.2.3 "https://www.nuget.org/packages/BinanceTR/1.2.3"))

**NuGet PM**
```
Install-Package BinanceTR -Version 1.2.3
```

**dotnet cli**
```
dotnet add package BinanceTR --version 1.2.3
```
## Yol Haritası
